package com.github.nikhilbhutani.sunshine.sync;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        Log.d(LOG_TAG, "onPerformSync Called, Sync started");
        ...
        try {
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(APPID_PARAM, "Enter your Api Key")
                    .build();
    ...
    static private void setLocationStatus(Context c, @LocationStatus int locationStatus){
        ...
        spe.commit(); // Used commit here instead of apply, because this will be running on the background thread.
    }
}